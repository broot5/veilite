...
pub(crate) struct FixtureCase {
    ...
    pub(crate) cipher: FixtureCipher,
    pub(crate) fixture: &'static [u8],
    pub(crate) passphrase: &'static [u8],
    pub(crate) page_size: usize,
    pub(crate) reserve_size: usize,
}

impl FixtureCase {
    pub(crate) fn config(self) -> CipherConfig {
        match self.cipher {
...
pub(crate) const SQLCIPHER3_CASE: FixtureCase = FixtureCase {
    name: "sqlcipher3",
...
pub(crate) const SQLCIPHER4_CASE: FixtureCase = FixtureCase {
    name: "sqlcipher4",
...
pub(crate) const SQLCIPHER_CUSTOM_CASE: FixtureCase = FixtureCase {
...
pub(crate) const PRESET_FIXTURE_CASES: [FixtureCase; 2] = [SQLCIPHER3_CASE, SQLCIPHER4_CASE];
pub(crate) const FIXTURE_CASES: [FixtureCase; 3] =
